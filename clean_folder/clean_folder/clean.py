...
registered_extensions = {    # словарь для сортировки файлов по расширению
    'JPEG': image_files, 'PNG': image_files, 'JPG': image_files, 'SVG': image_files,
    'AVI': video_files, 'MP4': video_files, 'MOV': video_files, 'MKV': video_files,
    'DOC': docx_files, 'DOCX': docx_files, 'TXT': docx_files, 'PDF': docx_files, 'XLSX': docx_files, 'PPTX': docx_files,
